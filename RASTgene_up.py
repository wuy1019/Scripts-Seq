...
def get_para():
    ...
    ----------------------------------------------------------------------------
    Veision: 0.3, support RAST gff file
    Author:  wuy1019@live.com
    Notice:  fasta file title must be equal column one of gff file
             raw RAST gff file must be used script "RASTgff_sort.py" preproccess
    ----------------------------------------------------------------------------"""
...
def GffInfo(Gff_file):
    ...
    :return: gff[contig][n] = [title, start, end, direction, annotation]
    """
    global i
    gff = Ddict()
    try:
        ...
        try:
            ...
            for line in file_gff:
                ...
                if line_l[2] == "CDS" or "RNA" in line_l[2]:
                    ...
                    gff[line_l[0]][i] = [cache_dict["ID"], line_l[3], line_l[4],
                                         line_l[6], cache_dict["Name"]]
        except:
            pass
        finally:
            file_gff.close()
